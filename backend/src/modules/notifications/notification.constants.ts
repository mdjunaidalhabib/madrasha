...
/// student.service.ts (approveAdmission/updateStudent) and
/// fee.service.ts (recordPayment).
export const NOTIFICATION_EVENTS = ["ADMISSION", "INFO_UPDATE", "FEE_PAYMENT"] as const;
