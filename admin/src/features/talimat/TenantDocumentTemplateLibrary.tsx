...
import type { DocumentKind } from "@madrasha/shared-ui/src/components/DocumentDesigner/types";
import {
  listTemplates,
  getTemplate,
  getEffectiveDefault,
...
export default function TenantDocumentTemplateLibrary({
  ...
  const openInDesigner = (id: number) => navigate(`/talimat/settings/documents/${documentTypeToUrlSlug(type)}/${id}/edit`);
