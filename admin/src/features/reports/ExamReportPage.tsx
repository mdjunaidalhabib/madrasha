...
const reports: ReportMenuItem[] = [
  ...
  },
  {
    key: "seat-plan",
    title: "সিট প্ল্যান",
    subtitle: "কক্ষ ও আসন নম্বর অনুযায়ী পরীক্ষার্থীদের আসন বিন্যাস",
    endpoint: "/reports/academic/seat-plan",
    requiresExam: true,
    requiresDivision: true,
    columns: [
      { header: "কক্ষ", key: "room_name", className: smallCol },
      { header: "তারিখ", key: "exam_date", className: smallCol },
      { header: "বিষয়", key: "subject_name", className: nameCol },
      { header: "আসন নং", key: "seat_no", className: smallCol },
      { header: "রোল", key: "roll", className: smallCol },
      { header: "শিক্ষার্থীর নাম", key: "student_name", className: nameCol },
      { header: "শ্রেণি", key: "class_name", className: smallCol },
      { header: "বিভাগ", key: "division_name", className: midCol },
  ...
  },
  {
    ...
    title: "পরিদর্শক তালিকা",
    subtitle: "কক্ষ ও সময়সূচি অনুযায়ী নিয়োজিত পরিদর্শকদের তালিকা",
    ...
    columns: [
      ...
      { header: "বিষয়", key: "subject_name", className: nameCol },
      { header: "কক্ষ", key: "room_name", className: smallCol },
      { header: "পরিদর্শকের নাম", key: "invigilator_name", className: nameCol },
      { header: "মোবাইল", key: "invigilator_phone", className: smallCol },
      { header: "দায়িত্ব", key: "role", className: smallCol },
    ],
  },
  {
    key: "exam-attendance-sheet",
    title: "পরীক্ষার হাজিরা শিট",
    subtitle: "কক্ষভিত্তিক পরীক্ষার দিনের উপস্থিতি/অনুপস্থিতি তালিকা",
    ...
    columns: [
      ...
      { header: "রোল", key: "roll", className: smallCol },
      { header: "শিক্ষার্থীর নাম", key: "student_name", className: nameCol },
      { header: "অবস্থা", key: "status", className: smallCol },
    ],
  },
  {
    key: "exam-candidates",
    ...
    columns: [
      { header: "রোল নম্বর", key: "roll", className: smallCol },
      { header: "প্রার্থী নং", key: "exam_registration_no", className: idCol },
      { header: "শিক্ষার্থীর নাম", key: "student_name", className: nameCol },
      { header: "পিতার নাম", key: "father_name", className: nameCol },
      { header: "শ্রেণি", key: "class_name", className: smallCol },
      { header: "বিভাগ", key: "division_name", className: midCol },
      { header: "পরীক্ষা", key: "exam_name", className: midCol },
      { header: "অবস্থা", key: "candidate_status", className: smallCol },
      { header: "যোগ্যতা", key: "eligibility_status", className: smallCol },
    ],
  },
  {
    key: "exam-absentees",
