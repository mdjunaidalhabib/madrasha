...
export default function SuperAdminLoginPage() {
  ...
  return (
    <div className="flex h-screen items-center justify-center bg-gray-100 dark:bg-slate-950">
      <div className="bg-white p-6 rounded shadow w-full max-w-sm space-y-4 dark:bg-slate-900">
        <h2 className="text-xl font-bold text-gray-900 dark:text-slate-100">Super Admin Login</h2>
