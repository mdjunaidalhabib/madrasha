  ...
  return (
    <div className="relative" ref={containerRef}>
      <button
        ...
        className="flex h-9 items-center gap-1.5 rounded-md border border-gray-300 bg-white px-3 text-sm font-medium text-gray-700 transition hover:bg-gray-50"
      >
      ...
      {open && (
        <div className="absolute right-0 z-20 mt-1 w-56 rounded-lg border border-gray-200 bg-white p-2 shadow-lg">
          <p className="mb-1 px-1 text-xs font-semibold text-gray-500">কলাম দেখান / লুকান</p>
          ...
          <button
            type="button"
            onClick={onReset}
            className="mt-1 w-full rounded-md border-t border-gray-100 px-2 py-1.5 text-left text-xs text-blue-600 hover:bg-blue-50"
          >
            সব দেখান (ডিফল্ট)
          </button>
        </div>
