...
const AddressInfo: React.FC<Props> = ({ formData, setFormData }) => {
  ...
  return (
    <div className="bg-white shadow-lg p-6 rounded-xl border border-gray-200 mt-6">
      <h2 className="text-xl font-semibold mb-6 text-gray-700 border-b pb-3">ঠিকানার তথ্য</h2>

      {/* 4 Column Grid */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
        {/* Division */}
        <div className="flex flex-col">
          <label className="text-sm font-medium text-gray-600 mb-1">বিভাগ</label>
          <input
            name="division"
        ...
        {/* Thana */}
        <div className="flex flex-col">
          <label className="text-sm font-medium text-gray-600 mb-1">থানা / উপজেলা</label>
          <input
            name="thana"
        ...
        {/* Village */}
        <div className="flex flex-col">
          <label className="text-sm font-medium text-gray-600 mb-1">গ্রাম</label>
          <input
            name="village"
