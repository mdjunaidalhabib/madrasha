...
const SanadList = ({
  ...
  const defaultDocTemplate = useDocumentTemplateDefaultStore((s) => s.defaults.CERTIFICATE);
  const defaultDocTemplateLoaded = useDocumentTemplateDefaultStore((s) => s.loaded.CERTIFICATE);
